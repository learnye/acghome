            ...
            <div class="producrt-add">
                <div class="content-setting">
                    ...
                    <div class="input-item">
                        ...
                        <div class="item-content">
                            <input v-model="pid" type="text" id="product_id" autocomplete="off" class="input-inner">
                        </div>
                    </div>
                    <div class="input-item">
                    ...
                    <div class="input-item is-require">
                     ...
                     <div class="input-item is-require">
                        ...
                        <div class="file-upload-design" :style="`background-image:url(${avatar});`">
...
export default {
    ...
    methods: {
        ...
        submitProduct(){
            ...
            // 将商品信息传入pro_info
            this.axios.post('/insert_product',data).then(res=>{
                if(res.data.code==1){
                    // console.log('success');
                }else{
                    // console.log('error');
                ...
                // 将商品其他信息传入pro_spec
                this.axios.post('/insert_spec',data1).then(res=>{
                    if(res.data.code==1){
                    alert('商品添加成功');
